...
use crate::events::WithdrawalQueueProcessed;
use crate::states::{BackerDeposit, TreasuryPool, WithdrawalQueueEntry};
...
pub fn process_withdrawal_queue(
    ...
    require!(queue_entry.is_pending(), ErrorCode::WithdrawalAlreadyProcessed);
